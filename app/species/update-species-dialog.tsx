...
export default function UpdateSpeciesDialog({ userId, spcs }: { userId: string; spcs: Species }) {
  const router = useRouter();

  let defaultValues: Partial<FormData> = {
    scientific_name: spcs.scientific_name,
    common_name: spcs.common_name,
    kingdom: spcs.kingdom,
    total_population: spcs.total_population,
    image: spcs.image,
    description: spcs.description,
  };
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="secondary">
          <Icons.media className="mr-3 h-5 w-5" />
          Edit Species
        </Button>
      </DialogTrigger>
      <DialogContent className="max-h-screen overflow-y-auto sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>Update Species</DialogTitle>
          <DialogDescription>
            Update species here. Click &quot;Update Species&quot; below when you&apos;re done.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form onSubmit={(e: BaseSyntheticEvent) => void form.handleSubmit(onSubmit)(e)}>
            <div className="grid w-full items-center gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder={spcs.scientific_name} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Kingdom {spcs.kingdom}</FormLabel>
                    <Select
                      defaultValue={spcs.kingdom}
